### Què és? 
És la manera que té l'usuari per comunicar-se amb el sistema. Una bona interfície d'usuari evita que l'usuari cometi errors.
...
- **Consistència**: Quan utilitzem el sistema, ha de donar la sensació que estem sempre al mateix sistema i a la mateixa interfície per a tots els dispositius.
- **Ubicació**: en cada moment has de saber on estàs dins de l'aplicació. Per exemple logotip i marca, títols, url, breadcrumbs, pistes visuals , canvis visuals, mostrar passos... 
- **Navegació**: facilitat per moure't per les seccions i trobar la informació que necessites.
- **Identitat**: Ha de quedar clar a quina aplicació estàs. Com fer-ho? Colors associats a la marca, posar el logo a la web.
- **Factors humans**: Els humans són la part més imprevisible. S'ha de tenir en compte que les persones no tenen memòria, per tant se'ls hi ha de posar fàcil. Per exemple, n'hi poden haver de físics, cognitius, emocionals, socials ...

### Elements UI
- **Espai d'interacció**: 
	- Fluid design: Capacitat d'una IU per adaptar els elements a la mida dels dispositius, fent servir percentatges en lloc de píxels.
...
- **Icones**:
	- Símbols o imatges de mida petita amb la que es representen en general, qualsevol element d'un sistema informàtic. S'han de poder reconèixer i memoritzar amb facilitat.
- **Estil dels missatges:**
	- Manera d'escriure els missatges d'informació i error. Poden tenir un to mes humorístic o seriós, formal o informal, ...
	- Els missatges han de ser clars i en casos importants mostrar un missatge abans de la confirmació.
